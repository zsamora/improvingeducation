...
<div>
  ...
  <div id="initial-text" class="col-md-6"><h2>¡Bienvenid@ a SED (Sistema de Evaluaciones de Desempeño), la plataforma para evaluar el desempeño de sus compañer@s de trabajo. Ingrese su nombre de usuario y contraseña para empezar!</h2></div>
