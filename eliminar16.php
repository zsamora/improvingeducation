...
$eliminar = "DELETE FROM ciclos WHERE id = $id_eliminar";
$eliminar_result = $conn->query($eliminar) or die ("database error:".$conn->error);
$eliminar2 = "DELETE FROM trabaja WHERE ciclo_id = $id_eliminar";
$eliminar2_result = $conn->query($eliminar2) or die ("database error:".$conn->error);
$eliminar = "DELETE FROM superiores_id WHERE ciclo_id = $id_eliminar OR ciclo2_id = $id_eliminar";
$eliminar_result = $conn->query($eliminar) or die ("database error:".$conn->error);
$eliminar = "DELETE FROM opinantes WHERE ciclo_id = $id_eliminar OR ciclo_sup = $id_eliminar";
$eliminar_result = $conn->query($eliminar) or die ("database error:".$conn->error);
$evalcomp = "SELECT id FROM evaluaciones_comp
										WHERE ciclo_id = $id_eliminar
											 OR ciclo_sup = $id_eliminar";
